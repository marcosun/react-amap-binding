 ...
 * the event callback is called, changes made to event callbacks will be honoured.
 * By contrast, one may cancel an event listener and attach a new listener if props get updated.
