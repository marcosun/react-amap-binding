 ...
 * TileLayerTraffic default display, you can toggle show or hide by visible config.
...
class TileLayerTraffic extends React.Component {
  ...
  /**
   * Initial traffic tileLayer
   */
  initTileLayerTraffic() {
    this.tileLayerTraffic = new window.AMap.TileLayer.Traffic(this.tileLayerTrafficOptions);

    this.props.visible === false ? this.tileLayerTraffic.hide() : null;
  }
