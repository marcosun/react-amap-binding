 ...
 * MassMarks default display, you can toggle show or hide by visible config.
 ...
 * @param {Function} onDblClick - Double click callback
 * @param {Function} onMouseOut - Mouse out callback
 * @param {Function} onMouseUp - Mouse up callback
 * @param {Function} onMouseDown - Mouse down callback
 * @param {Function} onTouchStart - Touch start callback
 * @param {Function} onTouchEnd - Touch end callback
 */
class MassMarks extends React.Component {
  ...
  initMassMarks() {
    ...
    this.massMarks = new window.AMap.MassMarks(data, this.massMarksOptions);

    this.massMarks.setMap(map);

    visible === false ? this.massMarks.hide() : null;
  }
