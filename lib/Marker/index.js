...
class Marker extends React.Component {
  ...
  shouldComponentUpdate(nextProps, nextState) {
    ...
    this.setOffset(this.markerOptions.offset, nextMarkerOptions.offset);

    this.setPosition(this.markerOptions.position, nextMarkerOptions.position);
   ...
   * @param {Array} currentOffset
   * @param {Array} nextOffset
   */
  setOffset(currentOffset, nextOffset) {
    if (!isShallowEqual(currentOffset, nextOffset)) {
      this.marker.setOffset(nextOffset);
    }
  }
